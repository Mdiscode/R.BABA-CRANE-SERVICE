<div class="col-lg-3 border-end-lg">
  <div class="aside-content">
    ...
    <div class="d-grid my-3">
      <a class="btn btn-primary" href="{{route('admin.email.compose')}}">Compose Email</a>
    </div>
  <div class="email-aside-nav">
    <ul class="nav flex-column">
      <li class="nav-item @if(Request::segment(3) == 'index') active @endif">
