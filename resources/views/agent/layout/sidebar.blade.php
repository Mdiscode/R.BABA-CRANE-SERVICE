<nav class="sidebar">
    ...
    <div class="sidebar-body">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a href="{{route('agent.agent_locksheet')}}" class="nav-link">
                    <i class="link-icon" data-feather="box"></i>
            ...
            {{-- <li class="nav-item">
                ...
                <div class="sub-menu hidden">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="#" class="nav-link">CardData-List</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">Contact-List</a>
                        </li>
                        <li class="nav-item">
                            <a href="#" class="nav-link">UserRole-List</a>
                        </li>
                    </ul>
                </div>
            </li> --}}
            ...
            <li class="nav-item">
                <a href="{{route('company.addlocksheet')}}" class="nav-link">
                    <i class="link-icon" data-feather="box"></i>
                    <span class="link-title">Ad-LockSheet</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('company.addCompany')}}" class="nav-link">
                    <i class="link-icon" data-feather="box"></i>
                    <span class="link-title">Add-Company</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="{{route('company.addOperator')}}" class="nav-link">
                    <i class="link-icon" data-feather="box"></i>
                    <span class="link-title">Add-Operator</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link sub-btn" id="sub-btn"  role="button"
                ...
                <div class="sub-menu hidden">
                    <ul class="nav sub-menu">
                        <li class="nav-item">
                            <a href="{{route('company.CompanyList')}}" class="nav-link">Company-List</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('company.Operatorlist')}}" class="nav-link">Operator-List</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('company.lockSheet-list')}}" class="nav-link">Lock-sheet-List</a>
                        </li>
                    </ul>
                </div>
            </li> --}}
