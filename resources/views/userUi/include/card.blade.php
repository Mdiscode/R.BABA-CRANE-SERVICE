  ...
  <div class="md:flex  bg-white">
    ...
    <div class="p-4">
      ...
      <div class="mt-4 flex items-center justify-around">
        {{-- <button data-bs-target="#InquiryModal"  data-bs-toggle="modal" class="px-2 py-2 bg-orange-500 text-white rounded hover:bg-orange-600 focus:outline-none flex items-center">
          <ion-icon name="call-outline" class="w-6 h-6 px-2"></ion-icon>
